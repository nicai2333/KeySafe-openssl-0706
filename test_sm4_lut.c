...
void main()
{
    ...
    {
        printf("[1]\n");
        printf("Debug: EVP_sm4_lut_ecb() test\n");
        test_encrypt_with_cipher(&tc, EVP_sm4_lut_ecb());
        printf("Debug: EVP_sm4_ecb() test\n");
        test_encrypt_with_cipher(&tc, EVP_sm4_ecb());
        printf("Debug: EVP_sm4_lut_cbc() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_lut_cbc());
        printf("Debug: EVP_sm4_cbc() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_cbc());
        printf("Debug: EVP_sm4_lut_ctr() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_lut_ctr());
        printf("Debug: EVP_sm4_ctr() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_ctr());
        printf("Debug: EVP_sm4_lut_gcm() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_lut_gcm());
        printf("Debug: EVP_sm4_gcm() test\n");
        test_encrypt_with_cipher(&tc_2, EVP_sm4_gcm());
    }
}
#endif