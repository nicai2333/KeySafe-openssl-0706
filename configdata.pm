...
our %config = (
  ...
  build_infos => [ "./build.info", "crypto/build.info", "ssl/build.info", "engines/build.info", "apps/build.info", "test/build.info", "util/build.info", "tools/build.info", "fuzz/build.info", "crypto/objects/build.info", "crypto/md4/build.info", "crypto/md5/build.info", "crypto/sha/build.info", "crypto/mdc2/build.info", "crypto/hmac/build.info", "crypto/ripemd/build.info", "crypto/whrlpool/build.info", "crypto/poly1305/build.info", "crypto/blake2/build.info", "crypto/siphash/build.info", "crypto/sm3/build.info", "crypto/des/build.info", "crypto/aes/build.info", "crypto/rc2/build.info", "crypto/rc4/build.info", "crypto/idea/build.info", "crypto/aria/build.info", "crypto/bf/build.info", "crypto/cast/build.info", "crypto/camellia/build.info", "crypto/seed/build.info", "crypto/sm4/build.info", "crypto/chacha/build.info", "crypto/modes/build.info", "crypto/bn/build.info", "crypto/ec/build.info", "crypto/rsa/build.info", "crypto/dsa/build.info", "crypto/dh/build.info", "crypto/sm2/build.info", "crypto/sm9/build.info", "crypto/dso/build.info", "crypto/engine/build.info", "crypto/buffer/build.info", "crypto/bio/build.info", "crypto/stack/build.info", "crypto/lhash/build.info", "crypto/rand/build.info", "crypto/err/build.info", "crypto/evp/build.info", "crypto/asn1/build.info", "crypto/pem/build.info", "crypto/x509/build.info", "crypto/x509v3/build.info", "crypto/conf/build.info", "crypto/txt_db/build.info", "crypto/pkcs7/build.info", "crypto/pkcs12/build.info", "crypto/comp/build.info", "crypto/ocsp/build.info", "crypto/ui/build.info", "crypto/cms/build.info", "crypto/ts/build.info", "crypto/srp/build.info", "crypto/cmac/build.info", "crypto/ct/build.info", "crypto/async/build.info", "crypto/kdf/build.info", "crypto/store/build.info", "crypto/soft_sdf/build.info", "test/ossl_shim/build.info" ],
  build_type => "debug",
  builddir => ".",
  cflags => [ "-g -mavx2 -mavx512f -mavx512bw", "-Wa,--noexecstack", " -DOPENSSL_NO_SM3_NEON" ],
  conf_files => [ "Configurations/00-base-templates.conf", "Configurations/10-main.conf" ],
  cppflags => [  ],
  cxxflags => [ "-g -mavx2 -mavx512f -mavx512bw" ],
  defines => [  ],
  ...
  perlenv => {
      ...
      "RM" => undef,
      "WINDRES" => undef,
      "__CNF_CFLAGS" => "-g -mavx2 -mavx512f -mavx512bw",
      "__CNF_CPPDEFINES" => "",
      "__CNF_CPPFLAGS" => "",
      "__CNF_CPPINCLUDES" => "",
      "__CNF_CXXFLAGS" => "-g -mavx2 -mavx512f -mavx512bw",
      "__CNF_LDFLAGS" => "",
      "__CNF_LDLIBS" => "",
  },
  prefix => "",
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "mdc2", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "idea", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "sm9", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store", "soft_sdf" ],
  shlib_major => "1",
  shlib_minor => "1",
            ...
            "crypto/sm3" =>
                {
                    "deps" =>
                        [
                            "crypto/sm3/m_sm3-avx.o",
                            "crypto/sm3/m_sm3-neon.o",
                            "crypto/sm3/m_sm3.o",
                            "crypto/sm3/sm3-avx.o",
                            "crypto/sm3/sm3-neon.o",
                            "crypto/sm3/sm3.o",
                        ],
                    "products" =>
                        {
            ...
            "crypto/soft_sdf" =>
                {
                    "deps" =>
                        [
                            "crypto/soft_sdf/debug.o",
                            "crypto/soft_sdf/hex.o",
                            "crypto/soft_sdf/sdf_ext.o",
                            "crypto/soft_sdf/sdf_lib.o",
                            "crypto/soft_sdf/sdf_meth.o",
                            "crypto/soft_sdf/sdf_sansec.o",
                            "crypto/soft_sdf/sdf_sm2.o",
                            "crypto/soft_sdf/sdf_sm3.o",
                            "crypto/soft_sdf/sdf_sm4.o",
                        ],
                    "products" =>
                        {
                            "lib" =>
    ...
    "sources" =>
        {
            ...
            "crypto/sm3/m_sm3-avx.o" =>
                [
                    "crypto/sm3/m_sm3-avx.c",
                ],
            "crypto/sm3/m_sm3-neon.o" =>
                [
                    "crypto/sm3/m_sm3-neon.c",
                ],
            "crypto/sm3/m_sm3.o" =>
                [
                    "crypto/sm3/m_sm3.c",
            ...
            "crypto/sm3/sm3-avx.o" =>
                [
                    "crypto/sm3/sm3-avx.c",
                ],
            "crypto/sm3/sm3-neon.o" =>
                [
                    "crypto/sm3/sm3-neon.c",
                ],
            "crypto/sm3/sm3.o" =>
                [
                    "crypto/sm3/sm3.c",
            ...
            "crypto/sm4/sm4_lut.o" =>
                [
                    "crypto/sm4/sm4_lut.c",
                ],
            "crypto/sm9/sm9_test.o" =>
                [
                    "crypto/sm9/sm9_test.c",
                ],
            "crypto/soft_sdf/debug.o" =>
                [
                    "crypto/soft_sdf/debug.c",
                ],
            "crypto/soft_sdf/hex.o" =>
                [
                    "crypto/soft_sdf/hex.c",
                ],
            "crypto/soft_sdf/sdf_ext.o" =>
                [
                    "crypto/soft_sdf/sdf_ext.c",
                ],
            "crypto/soft_sdf/sdf_lib.o" =>
                [
                    "crypto/soft_sdf/sdf_lib.c",
                ],
            "crypto/soft_sdf/sdf_meth.o" =>
                [
                    "crypto/soft_sdf/sdf_meth.c",
                ],
            "crypto/soft_sdf/sdf_sansec.o" =>
                [
                    "crypto/soft_sdf/sdf_sansec.c",
                ],
            "crypto/soft_sdf/sdf_sm2.o" =>
                [
                    "crypto/soft_sdf/sdf_sm2.c",
                ],
            "crypto/soft_sdf/sdf_sm3.o" =>
                [
                    "crypto/soft_sdf/sdf_sm3.c",
                ],
            "crypto/soft_sdf/sdf_sm4.o" =>
                [
                    "crypto/soft_sdf/sdf_sm4.c",
                ],
            "crypto/srp/srp_lib.o" =>
                [
